...
export default defineNuxtConfig({
    app: {
        head: {
            ...
            meta: [
                { name: 'Магазин БУ автозапчастей, купить БУ запчасти, качественные автозапчасти, дешевые автозапчасти, авторазборка', content: 'Ищете надежные БУ запчасти для вашего автомобиля? Наш магазин предлагает широкий ассортимент качественных автозапчастей по доступным ценам. Гарантия качества, быстрая доставка и консультации экспертов.' }
            ],
            link: [
                { rel: 'stylesheet', href: 'https://cdnjs.cloudflare.com/ajax/libs/egjs-flicking/4.3.0/flicking.css', crossorigin: 'anonymous' },
                { rel: 'stylesheet', href: 'https://cdnjs.cloudflare.com/ajax/libs/egjs-flicking/4.3.0/flicking-inline.css', crossorigin: 'anonymous' },
