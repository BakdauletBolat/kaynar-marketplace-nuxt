...
const serverAssets = [{"baseName":"server","dir":"/Users/bolat/PycharmProjects/kaynar-marketplace/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/bolat/PycharmProjects/kaynar-marketplace","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/bolat/PycharmProjects/kaynar-marketplace/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/bolat/PycharmProjects/kaynar-marketplace/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/bolat/PycharmProjects/kaynar-marketplace/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/bolat/PycharmProjects/kaynar-marketplace/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const rootDir = "/Users/bolat/PycharmProjects/kaynar-marketplace";
...
const getClientManifest = () => import('file:///Users/bolat/PycharmProjects/kaynar-marketplace/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/bolat/PycharmProjects/kaynar-marketplace/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
