import { useSSRContext, defineComponent, ref, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, toDisplayString, createCommentVNode } from 'vue';
...
import { _ as _sfc_main$1$1, p as pushErrors } from './index-DGzW2OUa.mjs';
import { b as CardStorage, a as axiosInstance$1 } from './storage-BKhyjSh-.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col gap-1 w-full" }, _attrs))}><label${ssrRenderAttr("for", __props.placeholder)} class="text-nowrap">${ssrInterpolate(__props.placeholder)}</label><input class="${ssrRenderClass([{
        "border-red-400": unref(errorMessage)
      }, "px-3 py-1.5 border rounded-sm w-full"])}"${ssrRenderAttr("id", __props.placeholder)}${ssrRenderAttr("value", unref(value))}><div class="text-sm text-red-400">${ssrInterpolate(unref(errorMessage))}</div></div>`);
    };
  }
});
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Input/index.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const addError = pushErrors;
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${ssrRenderAttrs(mergeProps({
        ...
        class: ["mt-3 justify-center gap-3 items-center bg-primary p-3 flex text-center cursor-pointer rounded-sm", {
          "!bg-gray-400 text-white": __props.isLoading
        }]
      }, _attrs))}><span>${ssrInterpolate(__props.isLoading ? "\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430" : __props.name)}</span>`);
      if (__props.isLoading) {
        _push(`<div class="border-gray-300 h-7 w-7 animate-spin rounded-full border-2 border-t-primary"></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</button>`);
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Button/index.vue");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function createOrder() {
      ...
      axiosInstance$1.post("/api/orders/", body).then((res) => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "max-w-7xl mx-auto p-3" }, _attrs))}>`);
      _push(ssrRenderComponent(unref(TabGroup), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$1$1, { class: "mt-3" }, null, _parent2, _scopeId));
            _push2(`</div></div>`);
          } else {
            return [
              ...
              createVNode("div", { class: "grid lg:grid-cols-[1fr_400px] gap-5" }, [
                ...
                createVNode("div", { class: "bg-white rounded-lg p-4" }, [
                  ...
                  createVNode(_sfc_main$1$1, { class: "mt-3" })
                ])
              ])
            ];
          }
...
//# sourceMappingURL=create-CCP0jNl0.mjs.map
